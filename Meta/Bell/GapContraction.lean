...
Here that global assignment is named as the short co-indexed regime.  The
contextual gap layer stays pre-probabilistic: it records, in the shared
projection vocabulary, the obstruction to a contractible visible-to-interface
reading.
-/
...
/- AXIOM_AUDIT_BEGIN -/
#print axioms Meta.ClosedStabilityTheorem.BellShortCoindexation
#print axioms Meta.ClosedStabilityTheorem.BellPointwiseCHSHBound
#print axioms Meta.ClosedStabilityTheorem.bellPointwiseCHSHBound_of_shortCoindexation
#print axioms Meta.ClosedStabilityTheorem.BellContextualStructuralGap
#print axioms Meta.ClosedStabilityTheorem.BellContextualOperationalGap
#print axioms Meta.ClosedStabilityTheorem.structuralGapOfBellOperationalGap
#print axioms Meta.ClosedStabilityTheorem.bellContextualStructuralGap_not_contractible
#print axioms Meta.ClosedStabilityTheorem.bellContextualOperationalGap_not_contractible
/- AXIOM_AUDIT_END -/
